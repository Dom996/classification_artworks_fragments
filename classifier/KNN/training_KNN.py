...
f = open('../../DataSet/' + DatasetName + '/Output/KNN/Log KNN_Training.txt', "w")
original = sys.stdout
...
# clf = svm.LinearSVC()
clf = KNeighborsClassifier(n_neighbors=205, n_jobs=-1)
...
with open('../../DataSet/' + DatasetName + '/Output/KNN/model_KNN.h5', 'wb') as f:
    pk.dump(clf, f)
